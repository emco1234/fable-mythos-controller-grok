...
# Force a non-existent grok binary path so the adapter falls back to stubs
# when the user runs without an active Grok login.
export RELIABILITY_GROK_BIN="${RELIABILITY_GROK_BIN:-/nonexistent/grok-binary-by-script}"
